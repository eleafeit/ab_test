...
$purch = a + b x + c  z + d (x  z) + \varepsilon$
...
We can also build an uplift model for click probability, but we should use a logistic regression. 
```{r}
...
- Large sample -> look for heterogeneous treatment effects
